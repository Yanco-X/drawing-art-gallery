...
**Curation, added 2026-09-06.** The band shows the newest five until the owner says otherwise; hand-picked pieces take the first slots in the order they were picked, and whatever is left is filled from the newest work not already picked. Nothing picked is the default and is stored nowhere.
